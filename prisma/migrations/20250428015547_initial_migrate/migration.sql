...
CREATE TABLE `siswa` (
    ...
    UNIQUE INDEX `siswa_currentCourseId_key`(`currentCourseId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `siswa_certificate` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `memberCourseId` INTEGER NOT NULL,
    `certificateImage` VARCHAR(191) NOT NULL,
    `link` VARCHAR(191) NOT NULL,
    `title` VARCHAR(191) NOT NULL,
    `size` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `siswa_certificate_memberCourseId_key`(`memberCourseId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `siswa` ADD CONSTRAINT `siswa_currentCourseId_fkey` FOREIGN KEY (`currentCourseId`) REFERENCES `siswa_course`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `siswa_certificate` ADD CONSTRAINT `siswa_certificate_memberCourseId_fkey` FOREIGN KEY (`memberCourseId`) REFERENCES `siswa_course`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
